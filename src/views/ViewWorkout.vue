<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    <!-- App Message -->
    <div v-if="statusMessage || errorMessage" class="mb-10 p-4 rounded-md shadow-md bg-light-grey">
    ...
    <div v-if="dataLoaded === true">
      ...
      <div class="flex flex-col items-center p-8 rounded-md shadow-md bg-light-grey relative">
        <div v-if="user" class="flex absolute left-2 right-2 gap-x-2">
          ...
          bg-at-light-green shadow-lg">
            <img @click="deleteWorkout" class="h-3.5 w-auto" src="@/assets/images/trash-light.png" alt="delete" />
          </div>
        </div>

        <img v-if="data.workoutType === 'cardio'" class="h-24 w-auto" src="@/assets/images/running-light-green.png"
          alt="workout" />
        <img v-else class="h-24 w-auto" src="@/assets/images/dumbbell-light-green.png" alt="workout" />
        ...
        <div class="w-full mt-6">
          <input v-if="edit" v-model="data.workoutName" type="text"
      ...
      <div class="mt-10 p-8 rounded-md flex flex-col item-center bg-light-grey shadow-md">
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          <div v-for="(item, index) in data.exercises" :key="index"
            class="flex flex-col gap-x-6 gap-y-2 relative md:flex-row">

            <div class="flex flex-2 flex-col md:w-1/3">
              <label for="exercise-name" class="mb-1 text-sm text-at-light-green">Exercise</label>
              <input id="exercise-name" v-if="edit" v-model="item.exercise" type="text"
                     class="p-2 w-full text-grey-500 focus:outline-none" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="sets" v-if="edit" v-model="item.sets" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="reps" v-if="edit" v-model="item.reps" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="weight" v-if="edit" v-model="item.weight" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
              <p v-else>{{item.weight}}</p>
            </div>

            <img @click="deleteExercise(item.id)" v-if="edit" class="absolute h-4 w-auto -left-5 cursor-pointer"
              src="@/assets/images/trash-light-green.png" alt="delete" />

          </div>

          <button @click="addExercise" v-if="edit" type="button" class="py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green
                                      duration-200 border-solid border-2 border-transparent hover:border-at-light-green
                                      hover:bg-white hover:text-at-light-green">Add Exercise</button>
        </div>
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          <div v-for="(item, index) in data.exercises" :key="index"
            ...
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <select v-if="edit" id="cardio-type" class="p-2 w-full text-gray-500 focus:outline--none focus:outline-none" v-model="item.cardioType">
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="distance" v-if="edit" v-model="item.distance" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="duration" v-if="edit" v-model="item.duration" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
            ...
            <div class="flex flex-1 flex-col">
              ...
              <input id="pace" v-if="edit" v-model="item.pace" type="text"
                class="p-2 w-full text-grey-500 focus:outline-none" />
      ...
      <!-- Update -->
      <button v-if="edit" @click="update" type="button" class="mt-10 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green
                                      duration-200 border-solid border-2 border-transparent hover:border-at-light-green
                                      hover:bg-white hover:text-at-light-green">Update Workout</button>
    </div>
  </div>
</template>
  ...
  setup() {
    ...
    const deleteWorkout = async () => {
      try {
        ...
        errorMessage.value = `Errpr: ${error.message}`;
      }
    };
    ...
    return { data, dataLoaded, statusMessage,
      errorMessage, edit, editMode, user,
      deleteWorkout, addExercise, deleteExercise, update };
  },
};
</script>
